...
function showPack() {
  ...
  if (pontos == 20) {
    alert(
      "51 É PINGA!!!! Você capturou todos os mundiais do palmeiras, o Porco está feliz!!! Clique em atualizar para jogar novamente."
    );
  }
}
...
function infoGame() {
  alert(
    "Ajude nosso amigo porco palmeirense a encontrar seus troféus. Objetivo do jogo: Capturar todas as 25 taças do mundial do palmeiras (Garrafas de 51). Atenção!! Ao capturar as taças verdadeiras você perde 1 ponto."
  );
}
